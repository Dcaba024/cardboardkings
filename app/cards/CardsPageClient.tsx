...
export default function CardsPageClient({
  ...
  const [listings, setListings] = useState<CardItem[]>(initialListings);
    ...
    <div className="min-h-screen bg-zinc-50 px-8 py-16 font-serif dark:bg-black">
      <main className="mx-auto w-full max-w-screen-2xl">
        <div className="mb-10 text-center">
          <h1 className="font-[var(--font-cinzel)] text-4xl font-bold uppercase tracking-[0.08em] text-black dark:text-yellow-400">
            Cards for sale
          </h1>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col gap-4 p-5">
                    <div>
                      ...
                      <p className="text-sm text-zinc-500 dark:text-zinc-400">{card.set}</p>
